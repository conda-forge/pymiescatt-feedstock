About pymiescatt-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymiescatt-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5086&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymiescatt-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymiescatt` can be installed with `conda`:
...
```
mamba install pymiescatt
```

It is possible to list all of the versions of `pymiescatt` available on your platform with `conda`:
...
```
mamba search pymiescatt --channel conda-forge
```
...
mamba repoquery search pymiescatt --channel conda-forge

# List packages depending on `pymiescatt`:
mamba repoquery whoneeds pymiescatt --channel conda-forge

# List dependencies of `pymiescatt`:
mamba repoquery depends pymiescatt --channel conda-forge
```
